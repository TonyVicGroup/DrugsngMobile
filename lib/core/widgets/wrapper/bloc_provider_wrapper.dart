  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create:
              (_) => DependencyInjectionService.inst.get<ProductDetailCubit>(),
        ),
        BlocProvider(
        ...
        BlocProvider(
          create:
              (_) => DependencyInjectionService.inst.get<TabNavigationCubit>(),
        ),
        BlocProvider(
          create:
              (_) => DependencyInjectionService.inst.get<NotificationCubit>(),
        ),
      ],
      child: child,
    );
