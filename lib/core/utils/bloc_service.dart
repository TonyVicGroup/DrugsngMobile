...
class BlocService {
  static get blocProviders => [
    BlocProvider(
      create: (_) => DependencyInjectionService.inst.get<NavigationTabCubit>(),
    ),
    BlocProvider(
    ...
    BlocProvider(
      create:
          (_) =>
              DependencyInjectionService.inst.get<ExploreMajorCategoryCubit>(),
    ),
    BlocProvider(
    ...
    BlocProvider(
      create: (_) => DependencyInjectionService.inst.get<PrescriptionCubit>(),
    ),
    BlocProvider(
      create: (_) => DependencyInjectionService.inst.get<OrderHistoryCubit>(),
    ),
    BlocProvider(
    ...
    BlocProvider(
      create: (_) => DependencyInjectionService.inst.get<ConsultationCubit>(),
    ),
    BlocProvider(
      create:
          (_) => DependencyInjectionService.inst.get<UserConsultationsCubit>(),
    ),
    BlocProvider(
      create: (_) => DependencyInjectionService.inst.get<CardCubit>(),
    ),
    BlocProvider(
      create: (_) => DependencyInjectionService.inst.get<StateAndCityCubit>(),
    ),
    BlocProvider(
