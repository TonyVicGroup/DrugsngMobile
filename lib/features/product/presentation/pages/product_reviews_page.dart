  ...
  static Route<dynamic> route(RouteSettings settings) {
    return MaterialPageRoute(
      builder:
          (_) => BlocProvider(
            create:
                (context) => ProductReviewCubit(
                  context.read<ProductDetailCubit>().state.product!.id,
                ),
            child: const ProductReviewsPage(),
          ),
    );
  }
                        ...
                        children: [
                          Container(
                            ...
                            child: DropdownButton<RatingFilterEnum>(
                              ...
                              onChanged: (v) {
                                if (v != null) {
                                  context.read<ProductReviewCubit>().filter(v);
                                }
                              },
                            ),
                          ),
                          _iconBtn(AppSvg.addReview, "Write a review", () {
                            ...
                            //   context,
                            //   AppUtils.transition(
                            //     NewReviewPage(productId: productId),
                            //   ),
                            // );
                          }),
                        ],
